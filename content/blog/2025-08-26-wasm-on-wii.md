...
Over the past year I have been running [a little experiment](https://github.com/pgattic/wasm-experiment) and seeing how far it goes. So far, it has successfully produced a lightweight, cross-platform Fantasy Console similar to the [PICO-8](https://www.lexaloffle.com/pico-8.php) but powered by [WebAssembly](https://webassembly.org/) rather than Lua.
